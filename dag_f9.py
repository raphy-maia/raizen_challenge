...
def xlsx():
  url = 'https://storage.googleapis.com/datalake-raizen/xlsx/vendas-combustiveis-m3.xlsx'
  response = request.urlretrieve(url, 'vendas-combustiveis-m3.xlsx')

def create_df():
  df_s1 = pd.read_excel('vendas-combustiveis-m3.xlsx', sheet_name=1)
  df_s2 = pd.read_excel('vendas-combustiveis-m3.xlsx', sheet_name=2)
  df_s3 = pd.read_excel('vendas-combustiveis-m3.xlsx', sheet_name=3)
...
with DAG(
        ...
        t1 >> t2 >> t3# Defining the task dependencies
